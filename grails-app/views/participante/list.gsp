                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="senha" title="${message(code: 'participante.senha.label', default: 'Senha')}" />
                        
                            <g:sortableColumn property="cpf" title="${message(code: 'participante.cpf.label', default: 'Cpf')}" />
                        
                            <g:sortableColumn property="instituicao" title="${message(code: 'participante.instituicao.label', default: 'Instituicao')}" />
                    ...
                    <g:each in="${participanteInstanceList}" status="i" var="participanteInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: participanteInstance, field: "senha")}</td>
                        
                            <td>${fieldValue(bean: participanteInstance, field: "cpf")}</td>
                        
                            <td>${fieldValue(bean: participanteInstance, field: "instituicao")}</td>
